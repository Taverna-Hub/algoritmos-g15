...
DEFAULT_OUTPUT = Path(__file__).resolve().parent / "mqtt_dados_eficiente.csv"
CLIENT_ID = "hardware-eficiente-csv-logger"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Escuta mensagens MQTT do hardware eficiente e salva packets em CSV."
    )
